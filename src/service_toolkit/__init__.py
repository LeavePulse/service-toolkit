...
_EXPORT_MODULES = {
    ...
    "DeliveryMessage": ".channels",
    "DeliveryResult": ".channels",
    "SmtpChannel": ".channels",
    "SmtpSettings": ".channels",
    ...
    "TimestampedStruct": ".models",
    "TolerantStrEnum": ".enums",
