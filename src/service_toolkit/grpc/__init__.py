...
_EXPORT_MODULES = {
    ...
    "reset_forwarded_on_behalf": ".jwt_forwarding",
    "set_forwarded_jwt": ".jwt_forwarding",
    "set_forwarded_on_behalf": ".jwt_forwarding",
